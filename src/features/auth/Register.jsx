    ...
    <div className="min-h-screen bg-gray-100 flex items-center justify-center p-6">
      <div className="w-full max-w-md bg-white rounded-3xl p-8 relative shadow-xl border border-gray-100">
        ...
        <form onSubmit={(e) => e.preventDefault()} className="flex flex-col gap-3">
          ...
          {/* Social buttons */}
          <div className="flex gap-3">
            <button className="flex-1 bg-gray-50 border border-gray-200 hover:bg-gray-100 rounded-xl py-3.5 flex items-center justify-center transition-colors">
          ...
          <p className="text-xs text-gray-400 text-center mt-1">
            ...
            <a href="#" className="text-indigo-500 hover:underline">Terms &amp; Service</a>.
          </p>
