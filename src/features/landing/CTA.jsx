      ...
      >
        ...
        <div className="relative z-10">
          <h2 className="text-3xl font-extrabold text-white leading-tight mb-3">
            Run Your Business from <br /> One Dashboard
          </h2>
          <p className="text-sm text-indigo-200 leading-relaxed mb-8">
            Everything you need to know before getting started <br /> clear answers, no confusion.
          </p>
          <button className="px-8 py-3 bg-indigo-500 hover:bg-indigo-600 text-white text-sm font-semibold rounded-xl transition-colors shadow-lg">
            Get Started
          </button>
        </div>
      </div>
...
function Footer() {
  return (
    <footer className="bg-white pt-16 pb-6 px-4 relative overflow-hidden">
      ...
      {/* Footer links row */}
      <div className="max-w-5xl mx-auto flex flex-row gap-12 mb-16 relative z-10">
        ...
        <div className="w-56 flex-shrink-0">
          ...
          <p className="text-xs text-gray-400 leading-relaxed mb-5">
            Everything you need to know before getting started—clear answers, no confusion, you need to know before started
          </p>
          {/* Social icons */}
      ...
      {/* Bottom bar */}
      <div className="max-w-5xl mx-auto flex justify-between items-center pt-6 border-t border-gray-100 relative z-10">
        <span className="text-xs text-gray-400">© All Copyrights reserve at Bizvance</span>
